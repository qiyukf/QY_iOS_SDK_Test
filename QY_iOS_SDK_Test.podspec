Pod::Spec.new do |s|
    ...
    s.source   = { :git => 'https://github.com/qiyukf/QY_iOS_SDK_Test.git', :tag => "7.7.2" }
    s.platform = :ios, '9.0'
    ...
    s.subspec 'Abroad' do |as|
    		as.source_files = ['**/Resources/QYResource.bundle', '**/Resources/QYLanguage.bundle', '**/Resources/QYCustomResource.bundle','**/QYNIMConfig+abroad.h','**/QYNIMConfig+abroad.m']
        as.vendored_frameworks = '**/QYSDK.framework'
        as.frameworks = 'QYSDK'
        as.dependency 'NIMSDK_LITE', '9.2.8'
        
    end  
    s.pod_target_xcconfig = { 'VALID_ARCHS' => 'rmv7,x86_64,arm64' }
    s.requires_arc = true

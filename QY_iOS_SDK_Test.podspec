Pod::Spec.new do |s|
    ...
    s.source   = { :git => 'https://github.com/qiyukf/QY_iOS_SDK_Test.git', :tag => "7.9.1" }
    s.platform = :ios, '9.0'
    ...
    s.subspec 'Video' do |vs|
    		vs.resources  = ['**/Resources/QYResource.bundle', '**/Resources/QYLanguage.bundle', '**/Resources/QYCustomResource.bundle']
        vs.vendored_frameworks = '**/QYSDK.xcframework'
        vs.dependency 'QY_NIMSDK_LITE', '8.9.3'
        vs.dependency 'NERtcSDK'
        vs.dependency 'QY_iOS_Video_SDK_Test','0.2.0'
    end

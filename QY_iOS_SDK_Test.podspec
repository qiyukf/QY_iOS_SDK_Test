Pod::Spec.new do |s|
    ...
    s.source   = { :git => 'https://github.com/qiyukf/QY_iOS_SDK_Test.git', :tag => "7.6.1" }
    s.platform = :ios, '9.0'
    ...
    s.resources  = ['**/Resources/QYResource.bundle', '**/Resources/QYLanguage.bundle', '**/Resources/QYCustomResource.bundle','**/foreign/**']
